      ...
      <div className="img w-full h-[25rem] md:h-[30rem] rounded-xl my-[1rem] mx-auto bg-contain bg-no-repeat">
        <div className="flex flex-col justify-center h-full ml-[1rem] md:ml-[5rem] animate-fadeIn">
          ...
          <div className="mt-6">
            <button
              type="button"
              className="py-1.5 md:py-2.5 px-5 me-2 mb-2 text-sm font-medium text-[#747474] focus:outline-none bg-white rounded-full border border-gray-200 hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-4 focus:ring-gray-100 dark:focus:ring-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-700 transform transition-transform hover:scale-105"
            >
              View Menu
            </button>
          </div>
